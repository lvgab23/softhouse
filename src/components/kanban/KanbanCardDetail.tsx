...
export function KanbanCardDetail({ card, columns, boardType, onClose, onSaved, onDeleted, onReload }: Props) {
  ...
  // URL para abrir/baixar: arquivos passam pela "portaria" (/api/kanban/anexo/[id]),
  // que confere o acesso ao portfólio antes de entregar. Links externos abrem direto.
  function fileUrl(att: CardAttachment): string {
    return att.type === 'file' && att.file_path ? `/api/kanban/anexo/${att.id}` : att.url
  }
      ...
      <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col" style={{ maxHeight: '92vh' }}>
          <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-100 flex-shrink-0">
            ...
            <a href={fileUrl(previewAtt)} target="_blank" rel="noopener noreferrer"
