    ...
    <AppLayout>
      ...
      <div className="p-6 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <MetricCard label="Valor Original Total" value={formatBRL(totalOriginal)} subtitle="valor de aquisição" icon={DollarSign} />
          <MetricCard label="Depreciação Acumulada" value={formatBRL(totalDepreciado)} subtitle="perda de valor calculada" icon={TrendingDown} />
          <MetricCard label="Valor Contábil Atual" value={formatBRL(totalAtual)} subtitle="valor contábil estimado" icon={BarChart3} />
        </div>
